Algoritmo sin_titulo
	...
	Si cafeImporte > 0 y sandwichImporte > 0 Entonces 
		Escribir "cafe ", cafeImporte		
		Escribir "sandwich ", sandwichImporte
		Escribir "importe total es ", sandwichImporte + cafeImporte
	SiNo
		Escribir "Tipo de cafe ", cafeTipo, " o tipo de sandwich ", sandwichTipo, " inválido" 			
	FinSi
